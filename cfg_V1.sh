...
#SBATCH --output=logs/V0_output.out         # Filename with STDOUT. You can use special flags, such as %N and %j.
#SBATCH --error=logs/V0_error.out           # (Optional) Filename with STDERR. If ommited, use STDOUT.
